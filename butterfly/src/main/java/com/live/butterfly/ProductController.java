...
public class ProductController {
    ...
    public List<Product> getAllProducts() {
        ...
        products.add(new Product(1, "http://localhost:8080/images/cerave_cleanser.png", "Bestseller", "Facewash",
                "CeraVe Hydrating Cleanser", "Cleanses and hydrates with 3 essential ceramides.", 14.99));
        products.add(new Product(2, "http://localhost:8080/images/cerave_cream.png", "Popular", "Moisturizer",
                "CeraVe Moisturizing Cream", "Barrier-restoring moisturizing cream for dry skin.", 19.50));
        products.add(new Product(3, "http://localhost:8080/images/cerave_lotion.png", null, "Lotion",
        ...
        products.add(new Product(6, "http://localhost:8080/images/sunsilk_shampoo.png", null, "Shampoo",
